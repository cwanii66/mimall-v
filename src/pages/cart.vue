                ...
                <div class="container">
                    <div class="cart-box">
                        ...
                        <ul class="cart-item-list">
                            ...
                            >
                                ...
                                <div class="item-name">
                                    <img v-lazy="item.productMainImage" alt="phone">
                    ...
                    <div class="order-wrap clearfix">
                        <div class="cart-tip fl">
                            <a href="/#/index">继续购物</a>
                            共<span> {{list.length}} </span>件商品，已选择<span> {{checkedNumber}} </span>件
                        </div>
                        <div class="total fr">
...
export default {
    ...
    methods: {
        ...
        // 控制全选功能
        toggleAll() {
            let toggleURL = this.allChecked ? '/carts/unSelectAll' : '/carts/selectAll';
            this.axios.put(toggleURL).then((res) => {
                this.renderData(res);
            })
        },
        //更新单个购物车以及单选状态
        ...
        renderData(res) {
            ...
            this.checkedNumber = this.list.filter(item => item.productSelected).length;
        },
        // 结算金额
        order() {
